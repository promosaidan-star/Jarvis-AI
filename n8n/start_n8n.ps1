...
$env:NODE_FUNCTION_ALLOW_BUILTIN = "fs,path,child_process"   # Code nodes read/write files; agent tools call the Python CLIs
$env:N8N_RESTRICT_FILE_ACCESS_TO = "C:\Users\ajwal\Documents\Jarvis-AI;C:\Users\ajwal\Documents\ai_agent_eval"
